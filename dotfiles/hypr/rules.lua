...
hl.window_rule({
	...
	match = {
		class = "zoom",
		title = "zoom_linux_float_video_window|as_toolbar|annotate_toolbar|ZoomAnnoArrowWindow|Annotation - Zoom|Presenter layout",
	},
	pin = false,
	decorate = false,
	no_anim = true,
...
hl.window_rule({
	...
	match = {
		class = "negative:vesktop|foot|floatterm|fusion360.exe|thorium-browser|dev.zed.Zed|spotify||teams-for-linux|com.obsproject.Studio|org.kde.kdenlive|gimp|google-chrome|chromium|zoom|Spotify|org.kde.krita",
		focus = false,
	},
...
hl.window_rule({
	name = "Games",
	match = {
		class = "genshinimpact.exe|osu!|moe.launcher.an-anime-game-launcher|osgViewer|org.vinegarhq.Sober|(Minecraft)(.*)",
	},
...
hl.workspace_rule({
	workspace = "special:discord",
	on_created_empty = "vesktop --enable-ozone-platform=wayland --enable-wayland-ime",
})
