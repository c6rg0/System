...

{
  programs.waybar = {
    ...
    style = ''
      @define-color color-bg                                  #2F2025;
      @define-color color-fg                                  #f2f2f2;
      @define-color color-button-bg                           #65a0a1;
      @define-color color-button-fg                           #2F2025;
      @define-color color-button-urgent-bg                    #c93237;
      @define-color color-button-urgent-fg                    #2F2025;
      @define-color color-workspace-button-bg                 #2F2025;
      @define-color color-workspace-button-fg                 #f2f2f2;
      @define-color color-workspace-button-hover-bg           #847068;
      @define-color color-workspace-button-hover-fg           #2F2025;
      @define-color color-workspace-button-focused-bg         #453038;
      @define-color color-workspace-button-focused-fg         #f2f2f2;
      @define-color color-taskbar-button-minimized-bg         #6B4B53;
      @define-color color-taskbar-button-minimized-fg         #2F2025;
      @define-color color-taskbar-button-active-bg            #688468;
      @define-color color-taskbar-button-active-fg            #2F2025;
      @define-color color-widget-audio-bg                     #2F2025;
      @define-color color-widget-audio-fg                     #f2f2f2;
      @define-color color-widget-audio-hover-bg               #2F2025;
      @define-color color-widget-audio-hover-fg               #f2f2f2;
      @define-color color-widget-audio-muted-bg               #2F2025;
      @define-color color-widget-audio-muted-fg               #f2f2f2;
      @define-color color-widget-clock-bg                     #2F2025;
      @define-color color-widget-clock-fg                     #f2f2f2;
      @define-color color-widget-battery-bg                   #2F2025;
      @define-color color-widget-battery-fg                   #f2f2f2;
      @define-color color-widget-battery-low-bg               #c93237;
      @define-color color-widget-battery-low-fg               #2F2025;
      @define-color color-widget-battery-low-blink-bg         #c93237;
      @define-color color-widget-battery-low-blink-fg         #2F2025;
      @define-color color-widget-backlight-bg                 #6B4B53;
      @define-color color-widget-backlight-fg                 #2F2025;
      @define-color color-widget-temperature-bg               #2F2025;
      @define-color color-widget-temperature-fg               #f2f2f2;
      @define-color color-widget-temperature-critical-bg      #c93237;
      @define-color color-widget-temperature-critical-fg      #2F2025;
      @define-color color-widget-memory-bg                    #2F2025;
      @define-color color-widget-memory-fg                    #f2f2f2;
      @define-color color-widget-cpu-bg                       #2F2025;
      @define-color color-widget-cpu-fg                       #f2f2f2;
      @define-color color-widget-power-profile-balanced-bg    #6B4B53;
      @define-color color-widget-power-profile-balanced-fg    #2F2025;
      @define-color color-widget-power-profile-performance-bg #CFB05F;
      @define-color color-widget-power-profile-performance-fg #2F2025;
      @define-color color-widget-power-profile-saver-bg       #688468;
      @define-color color-widget-power-profile-saver-fg       #2F2025;
      @define-color color-widget-network-bg                   #2F2025;
      @define-color color-widget-network-fg                   #f2f2f2;
      @define-color color-widget-tray-bg                      #f2f2f2;
      @define-color color-widget-tray-needs-attention         #e84c58;
      @define-color color-widget-custom-notification-bg       #303035;
      @define-color color-widget-custom-notification-fg       #e6e6e8;
      @define-color color-widget-scratchpad-bg                #c93237;
      @define-color color-widget-scratchpad-fg                #c93237;
      @define-color color-widget-power-bg                     #65a0a1;
      @define-color color-widget-power-fg                     #2F2025;
      @define-color color-widget-window-bg                    #6B4B53;
      @define-color color-widget-window-fg                    #2F2025;
      @define-color color-widget-keyboard-state-bg            #CD8266;
      @define-color color-widget-keyboard-state-fg            #2F2025;
      @define-color color-widget-language-bg                  #CD8266;
      @define-color color-widget-language-fg                  #2F2025;
      @define-color color-tooltip-bg                          #2F2025;
      @define-color color-tooltip-fg                          #f2f2f2;
      @define-color color-menu-bg                             #2F2025;
      @define-color color-menuitem-bg                         #2F2025;
      @define-color color-menuitem-fg                         #f2f2f2;
      @define-color color-menuitem-hover-bg                   #688468;
      @define-color color-menuitem-hover-fg                   #2F2025;
      @define-color color-menuitem-active-bg                  #f2f2f2;
      @define-color color-menuitem-active-fg                  #2F2025;
      @define-color color-gradient-fade                       #f2f2f2;
