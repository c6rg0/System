/*
 * TODO, Optimise:
 * This module interupts the UI until a list of connectable
 * networks is gathered. Ideally, it should show the popup 
 * immediately and allow the disruption of its further
 * loading.
 */
