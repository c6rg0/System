...
FloatingWindow {
    ...
    RowLayout {
        ...
        ColumnLayout {
			...
			//TODO: Make a script to scrape data to display
            Text {
                text: "NixOS"
                font.pixelSize: 20
            ...
            SpecRow {
                label: "Processor"
                value: "Intel i5-10300H @ 4.50 GHz"
            }
            SpecRow {
                label: "Memory"
                value: "32GB DDR4"
			...
			*/
            SpecRow {
                label: "Graphics"
                value: "NVIDIA GeForce GTX 1650 Mobile"
            }
    ...
    ColumnLayout {
        ...
        Text {
			text: "Credits: Luyu-wu/Config and c6rg0/System"
            font.pixelSize: 10
            color: "#888888"
            Layout.alignment: Qt.AlignHCenter
        }
