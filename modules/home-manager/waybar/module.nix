...

{
  programs.waybar = {
    ...
    style = ''
      ...
      @define-color color-workspace-button-bg                 #24221c;
      @define-color color-workspace-button-fg                 #ebddb2;
      @define-color color-workspace-button-hover-bg           #a89984;
      @define-color color-workspace-button-hover-fg           #24221c;
      @define-color color-workspace-button-focused-bg         #ebdbb2;
      @define-color color-workspace-button-focused-fg         #24221c;
      ...
      @define-color color-widget-audio-bg                     #24221c;
      @define-color color-widget-audio-fg                     #ebddb2;
      @define-color color-widget-audio-hover-bg               #24221c;
      @define-color color-widget-audio-hover-fg               #ebddb2;
      @define-color color-widget-audio-muted-bg               #24221c;
      @define-color color-widget-audio-muted-fg               #ebddb2;
      @define-color color-widget-clock-bg                     #24221c;
      @define-color color-widget-clock-fg                     #ebddb2;
      @define-color color-widget-battery-bg                   #24221c;
      @define-color color-widget-battery-fg                   #ebddb2;
      ...
      @define-color color-widget-temperature-bg               #24221c;
      @define-color color-widget-temperature-fg               #ebddb2;
      @define-color color-widget-temperature-critical-bg      #df402f;
      @define-color color-widget-temperature-critical-fg      #1b1a1a;
      @define-color color-widget-memory-bg                    #24221c;
      @define-color color-widget-memory-fg                    #ebddb2;
      @define-color color-widget-cpu-bg                       #24221c;
      @define-color color-widget-cpu-fg                       #ebddb2;
      ...
      @define-color color-widget-network-bg                   #24221c;
      @define-color color-widget-network-fg                   #ebddb2;
      @define-color color-widget-tray-bg                      #ebddb2;
